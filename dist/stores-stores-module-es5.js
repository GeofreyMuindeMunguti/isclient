...
var StoresAddComponent = /** @class */ (function () {
    function StoresAddComponent(fb, http, router) {
        this.fb = fb;
        this.http = http;
        this.router = router;
        this.createForm();
    }
    StoresAddComponent.prototype.ngOnInit = function () {
    };
    StoresAddComponent.prototype.createForm = function () {
    ...
    StoresAddComponent.prototype.onSubmit = function () {
        var _this = this;
        //   console.log(this.storeForm.value);
        var data = this.storeForm.value;
        var action = this.http.post(_config_dev__WEBPACK_IMPORTED_MODULE_5__["config"].url + '/stores', data);
        action.subscribe(function (data) {
            //  console.log(data);
            if (data) {
                _this.router.navigateByUrl('/pages/stores/stores-list');
            }
        });
    };
...
var StoresListComponent = /** @class */ (function () {
    function StoresListComponent(service, http) {
        var _this = this;
    ...
    StoresListComponent.prototype.getData = function () {
        var stores = this.http.get(_config_dev__WEBPACK_IMPORTED_MODULE_5__["config"].url + '/stores');
        return stores;
    };
    StoresListComponent.prototype.onDeleteConfirm = function (event) {
...
var StoresModule = /** @class */ (function () {
    ...
    StoresModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: _stores_routing_module__WEBPACK_IMPORTED_MODULE_4__["routedComponents"].slice(),
        })
    ], StoresModule);
    return StoresModule;
}());
