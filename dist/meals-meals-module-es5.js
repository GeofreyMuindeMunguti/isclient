...
var MealsAddComponent = /** @class */ (function () {
    function MealsAddComponent(fb, http, router) {
        this.fb = fb;
        this.http = http;
        this.router = router;
    ...
    MealsAddComponent.prototype.createForm = function () {
    ...
    MealsAddComponent.prototype.onSubmit = function () {
        var _this = this;
        ...
        console.log(data);
        var response = this.http.post(_config_dev__WEBPACK_IMPORTED_MODULE_5__["config"].url + '/meals', data);
        this.postFile(this.fileToUpload, data.img_url).subscribe(function (data) {
            console.log(data);
        });
        response.subscribe(function (data) {
            ...
            console.log(data);
            if (data) {
                _this.router.navigateByUrl('/pages/meals/meals-list');
            }
        });
        console.log("clicked submit");
    };
    MealsAddComponent.prototype.getStores = function () {
        var _this = this;
        var store = this.http.get(_config_dev__WEBPACK_IMPORTED_MODULE_5__["config"].url + '/stores');
        store.subscribe(function (data) {
            console.log(data);
            _this.powers = data;
        });
    };
    MealsAddComponent.prototype.handleFileInput = function (files) {
        this.fileToUpload = files.item(0);
    };
    MealsAddComponent.prototype.postFile = function (fileToUpload, filename) {
...
var MealsListComponent = /** @class */ (function () {
    function MealsListComponent(service, http) {
        var _this = this;
    ...
    MealsListComponent.prototype.onDeleteConfirm = function (event) {
    ...
    MealsListComponent.prototype.onconfirmSave = function (event) {
        if (window.confirm('Are you sure you want to delete?')) {
            event.confirm.resolve();
        }
        else {
    ...
    MealsListComponent.prototype.getData = function () {
        // var fetched_data;
...
var MealsRoutingModule = /** @class */ (function () {
    function MealsRoutingModule() {
    }
...
var MealsModule = /** @class */ (function () {
    ...
    MealsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: _meals_routing_module__WEBPACK_IMPORTED_MODULE_5__["routedComponents"].slice(),
        })
    ], MealsModule);
    return MealsModule;
}());
